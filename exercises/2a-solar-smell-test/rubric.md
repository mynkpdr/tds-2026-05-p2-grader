# Evaluator rubric - Ten-minute smell test: inverter event export
...
- No hidden mechanism is required here; the evaluator should reward justified stopping.
...
- does not invent a plant problem from a seven-minute communications warning
- notes zero MW impact and quick recovery
- may flag mixed event wording as low-priority quality check
- stops rather than searching for a story
